...
selectable-set-tsfmarsoc-fenghuang-kit-name = Комплект «Фэнхуан»
selectable-set-tsfmarsoc-fenghuang-kit-desc = Оружие MR-8B «Фэнхуан», четыре магазина 8×65 мм, вертикальная рукоятка, челюсти жизни и боевая аптечка.
